...
SRC_URI:append:aquila-imx95 = " https://docs.toradex.com/117028-sx-pcebe-board-files_v1.0.zip;name=sx-pcebe-board-files"
...
do_install:append:aquila-am69 () {
	...
	install -m 0644 ${WORKDIR}/sx-pcebe-board-files/board-2.bin          ${D}${ATH12K_FIRMWARE_PATH}
